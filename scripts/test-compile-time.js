...
const invalidCodeTests = [
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_2, LOCK_4 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_3, LOCK_5 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_3 } from 'src';
async function test() {
  const ctx3 = await createLockContext().acquireWrite(LOCK_3);
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_2 } from 'src';
async function test() {
  const ctx1 = await createLockContext().acquireWrite(LOCK_1);
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_2, LOCK_3 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_8, LOCK_12 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_6, LOCK_15 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_10 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_4, LOCK_9 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_2, LOCK_3, LOCK_5 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3, LOCK_4 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_10, LOCK_12, LOCK_15 } from 'src';
async function test() {
...
`
  ...
  // LocksAtMost flexible types - invalid patterns
  {
    ...
    code: `
import { createLockContext, LOCK_3, type LockContext, type LocksAtMost5 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, type LockContext, type LocksAtMost3 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_2, type LockContext, type LocksAtMost4 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_5, type LockContext, type LocksAtMost5 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_4, type LockContext, type LocksAtMost3 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_3, type LockContext, type LocksAtMost2 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_5, type LockContext, type LocksAtMost4 } from 'src';
...
`
  ...
  // NullableLocksAtMost types - invalid patterns
  {
    ...
    code: `
import { createLockContext, LOCK_12, type NullableLocksAtMost10, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_15, type NullableLocksAtMost12, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_14, type NullableLocksAtMost11, type LockLevel } from 'src';
...
`
  ...
  // HasLockContext types - invalid patterns
  {
    ...
    code: `
import { createLockContext, LOCK_1, type HasLock3Context, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_3, type HasLock5Context, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_8, type HasLock10Context, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_12, type HasLock15Context, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, type HasLock8Context, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3, LOCK_5 } from 'src';
async function test() {
  const ctx13 = await createLockContext().acquireWrite(LOCK_1).then(c => c.acquireWrite(LOCK_3));
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_5, LOCK_8, LOCK_10 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_2, LOCK_5 } from 'src';
async function test() {
  const ctx5 = await createLockContext().acquireWrite(LOCK_5);
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_4 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_2, LOCK_8, LOCK_10 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_2, LOCK_5, LOCK_8 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3, type LockContext, type LocksAtMostAndHas6 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, type LockContext, type LocksAtMostAndHas3 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_2, LOCK_3, LOCK_4 } from 'src';
import type { Contains, LockContext, LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_2, LOCK_4, LOCK_5 } from 'src';
async function test() {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3, LOCK_5 } from 'src';
import type { LockContext, LockLevel, Contains } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_6, LOCK_9, LOCK_12, LOCK_15 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_2, LOCK_8, LOCK_13 } from 'src';
...
`
  ...
  // LocksAtMost flexible types - valid patterns
  {
    ...
    code: `
import { createLockContext, type LockContext, type LocksAtMost5 } from 'src';
async function processWithFlexibleContext(ctx: LockContext<LocksAtMost5>): Promise<void> {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_4, LOCK_5, type LockContext, type LocksAtMost5 } from 'src';
async function processWithFlexibleContext(ctx: LockContext<LocksAtMost5>): Promise<void> {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3, type LockContext, type LocksAtMost3 } from 'src';
async function plugin(ctx: LockContext<LocksAtMost3>): Promise<void> {
  const locks = ctx.getHeldLocks();
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_5, LOCK_6, type LockContext, type LocksAtMost5 } from 'src';
async function processWithFlexibleContext(ctx: LockContext<LocksAtMost5>): Promise<void> {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_2, LOCK_3, type LockContext, type LocksAtMost3 } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3, LOCK_5, type LockContext, type LocksAtMost5 } from 'src';
...
import { createLockContext, LOCK_1, LOCK_2, LOCK_3, LOCK_4, LOCK_5, 
         type LockContext, type LocksAtMost3, type LocksAtMost5 } from 'src';
...
`
  ...
  // NullableLocksAtMost types - valid patterns
  {
    ...
    code: `
import { createLockContext, LOCK_8, type NullableLocksAtMost10, type LockLevel } from 'src';
function needsAtMost10<T extends readonly LockLevel[]>(ctx: NullableLocksAtMost10<T>): void {
  if (ctx !== null) {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_10, type NullableLocksAtMost12, type LockLevel } from 'src';
function needsAtMost12<T extends readonly LockLevel[]>(ctx: NullableLocksAtMost12<T>): void {
  if (ctx !== null) {
    console.log('Valid context:', ctx.getHeldLocks());
  }
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_15, type NullableLocksAtMost15, type LockLevel } from 'src';
...
`
  },
  {
    ...
    code: `
import { createLockContext, type NullableLocksAtMost11, type LockLevel } from 'src';
function needsAtMost11<T extends readonly LockLevel[]>(ctx: NullableLocksAtMost11<T>): void {
  if (ctx !== null) {
    console.log('Valid context:', ctx.getHeldLocks());
  }
...
`
  ...
  // HasLockContext types - valid patterns
  {
    ...
    code: `
import { createLockContext, LOCK_3, type HasLock3Context, type LockLevel } from 'src';
function needsLock3<T extends readonly LockLevel[]>(
  ctx: HasLock3Context<T> extends string ? never : HasLock3Context<T>
): void {
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_1, LOCK_3, LOCK_5, type HasLock5Context, type LockLevel } from 'src';
function needsLock5<T extends readonly LockLevel[]>(
  ctx: HasLock5Context<T> extends string ? never : HasLock5Context<T>
): void {
  console.log('Using context');
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_10, LOCK_12, type HasLock10Context, type LockLevel } from 'src';
function needsLock10<T extends readonly LockLevel[]>(
  ctx: HasLock10Context<T> extends string ? never : HasLock10Context<T>
): void {
  console.log('Using context');
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_15, type HasLock15Context, type LockLevel } from 'src';
function needsLock15<T extends readonly LockLevel[]>(
  ctx: HasLock15Context<T> extends string ? never : HasLock15Context<T>
): void {
  console.log('Using context');
...
`
  },
  {
    ...
    code: `
import { createLockContext, LOCK_5, LOCK_8, LOCK_10, type HasLock8Context, type LockLevel } from 'src';
function needsLock8<T extends readonly LockLevel[]>(
  ctx: HasLock8Context<T> extends string ? never : HasLock8Context<T>
): void {
  console.log('Using context');
